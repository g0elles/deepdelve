        ...
        if _get_workspace_type() == "disk":
            ...
            if encoding:
                ...
                with open(path, mode) as f:
                    f.write(chunk)
            # Deterministic, engine-level record of the (url, filename) pair — this is what the
            # real grounding check cross-references, independent of what the model later claims.
