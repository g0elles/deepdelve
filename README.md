...
- [`CYC2002tommy/Deep-Research-Agent`](https://github.com/CYC2002tommy/Deep-Research-Agent) — not a
  ...
  (verifying a claim's actual content against its source, not just that some URL was fetched) is a
  stronger check than anything built here yet — tracked as a possible future direction, not implemented.
